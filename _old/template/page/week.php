...
<body>
				...
				<div class="screen" data-tabs>
					...
					<div class="app" data-tab-widget=<?php echo $activeDay ?> data-context="week" data-leaguess="mkl">
						...
						<div class="page__title">
							...
							<h2>
								<a href="week.php" class="">W</a><span class="w-tiny c-text-5">/</span><a href="month.php" class="c-text-5">M</a>
							</h2>
						</div>
						<div></div>
						<div class="calendar">
	...
	<!-- global js -->
	<script src="/dist/js/app.dist.js?v=<?php echo $now ?>"></script>
	...
	<!-- end html -->
	<?php include('template/body/end.php'); ?>
