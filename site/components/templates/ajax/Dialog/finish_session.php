	...
	<div class="grid gap__3 inner-y__3 inner-x__1">
		<div class="flex justify__space-between">
			<div class="grid gap__05 inner-t__02">
				...
				<p class="op__6 font__size__md">Log or discard this session</p>
			</div>
		...
		<div class="grid gap__1">
			<form action="form/discard_workout" method="post" class="grid" modal-close-reload="modal/workout/index/workout=<?= $workout ?>">
			...
			<form action="form/log_workout" method="post" class="grid" modal-close-reload="modal/workout/index/workout=<?= $workout ?>">
				<input type="hidden" name="workout" value="<?= $workout ?>">
