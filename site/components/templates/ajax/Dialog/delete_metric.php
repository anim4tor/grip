	...
	<div class="grid gap__3 inner-y__3 inner-x__1">
		<div class="flex justify__space-between">
			<div class="grid gap__05 inner-t__02">
				<h1 class="">Delete metric</h1>
				<p class="op__6 font__size__lg">Delete <?= $metric['title'] ?> from dahsboard?</p>
			</div>
		...
		<div class="grid__2 gap__1">
			...
			<form action="form/delete_metric" method="post" class="grid" reload="/">
