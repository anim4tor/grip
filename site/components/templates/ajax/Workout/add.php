...
<tabs data-tabs class="grid modal__content rows__auto-1 ">
	...
	<div data-pane-container class="relative inset__stretch">
		<pane data-pane class="absolute inset__stretch grid rows__1-auto relative">
		...
		<pane data-pane class="absolute inset__stretch grid rows__1-auto relative">
			<div class="grid align__start">
				...
				<div class="grid">
					<div class="inner__1">
						<div class="border__bottom inner-y__1">
							<p class="font__size__lg">My back workout</p>
						</div>
					</div>
				</div>
			</div>
					...
					<div data-pane-container nested class="relative">
						<div data-pane nested class="absolute inset__stretch grid align__space-between">
							...
							<button-list class="flex align__start gap__1 inner__1 inner-b__5 wrap">
								<a modal-reveal class="button bg__invert/10">Sunday</a>
								<a modal-reveal class="button bg__invert color__dark">Monday</a>
								<a modal-reveal class="button bg__invert/10">Tuesday</a>
								<a modal-reveal class="button bg__invert/10">Wednesday</a>
								<a modal-reveal class="button bg__invert color__dark">Thursday</a>
								<a modal-reveal class="button bg__invert/10">Friday</a>
								<a modal-reveal class="button bg__invert/10">Saturday</a>
							</button-list>
						</div>
						<div data-pane nested class="absolute inset__stretch grid align__space-between ">
			...
			<footer class="inset__bottom-stretch z__1 bg__inherit relative">
				<div class="grid inner-y__2 inner-x__1 border__top shadow">
					<div class="flex justify__start align__center gap__1">
						<a modal-reveal modal-close class="button circle bg__invert color__dark"><icon><?= svg('public/assets/images/ui/ui_arrow-down.svg') ?></icon></a>
