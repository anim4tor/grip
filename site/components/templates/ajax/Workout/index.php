<div class="inner__1 inner-t__2 inner-b__1 flex align__center justify__space-between gap__05">
	<a class="button circle --left" data-modal-close><icon><?= svg('public/assets/images/ui/ui_arrow-down.svg') ?></icon></a>
	<nav class="button__group">
		<a class="button circle bg__invert/20"><icon><?= svg('public/assets/images/ui/ui_settings.svg') ?></icon></a>
		<a class="button circle bg__invert/20"><icon><?= svg('public/assets/images/ui/ui_calendar.svg') ?></icon></a>
		<a class="button bg__invert color__dark">Start</a>
	</nav>
</div>
<header class="">
...
<section data-section>
	<list class="grid gap-x__07 gap-y__2 inner__1">
		<exercise class="card flex justify__space-between align__start relative">
			<header class="flex gap__1 align__start">
				<div class="grid__stack place__center-center ">
					...
					<div superset class="superset absolute">
