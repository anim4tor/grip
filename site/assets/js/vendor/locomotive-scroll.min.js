! function(t, e) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t || self).LocomotiveScroll = e()
}(this, function() {
    function t() {
    ...
    function i(t, i) {
        ...
        if (Array.isArray(t) || (s = function(t, i) {
                if (t) {
    ...
    class r {
        advance(t) {
            ...
            let i = !1;
            if (this.lerp) this.value = (s = this.value, r = this.to, (1 - (o = 1 - Math.exp(-60 * this.lerp * t))) * s + o * r), Math.round(this.value) === this.to && (this.value = this.to, i = !0);
            else {
                this.currentTime += t;
            ...
            var s, r, o;
            null == (e = this.onUpdate) || e.call(this, this.value, i), i && this.stop()
        }
        stop() {
            this.isRunning = !1
        }
        fromTo(t, e, {
            ...
            this.from = this.value = t, this.to = e, this.lerp = i, this.duration = s, this.easing = n, this.currentTime = 0, this.isRunning = !0, null == r || r(), this.onUpdate = o
        }
    }
    class o {
        constructor({
    ...
    class h {
        constructor({
            ...
            syncTouch: u = !1,
            syncTouchLerp: d = .1,
            __iosNoInertiaSyncTouchLerp: v = .4,
            ...
            this.onVirtualScroll = ({
                ...
                if (o = o.slice(0, o.indexOf(this.rootElement)), o.find(t => {
                        var e;
                ...
                h && (l = this.velocity * this.options.touchInertiaMultiplier), this.scrollTo(this.targetScroll + l, s({
                    programmatic: !1
                }, a && {
                ...
                normalizeWheel: O,
                autoResize: y
            }, this.animate = new r, this.emitter = new l, this.dimensions = new o({
                wrapper: t,
                content: e,
                autoResize: y
            }), this.toggleClass("lenis", !0), this.velocity = 0, this.isLocked = !1, this.isStopped = !1, this.isSmooth = u || h || c, this.isScrolling = !1, this.targetScroll = this.animatedScroll = this.actualScroll, this.options.wrapper.addEventListener("scroll", this.onNativeScroll, {
                passive: !1
        ...
        scrollTo(t, {
            ...
            if (!this.isStopped && !this.isLocked || h) {
                ...
                if ("number" == typeof t) {
                    if (t += e, t = Math.round(t), this.options.infinite ? c && (this.targetScroll = this.animatedScroll = this.scroll) : t = n(0, t, this.limit), i) return this.animatedScroll = this.targetScroll = t, this.setScroll(this.scroll), this.reset(), void(null == a || a(this));
                    if (!c) {
    ...
    var c = /*#__PURE__*/ function() {
        function t(t) {
            var e = t.scrollElements,
                ...
                n = t.IORaf;
            this.scrollElements = void 0, this.rootMargin = void 0, this.IORaf = void 0, this.observer = void 0, this.scrollElements = e, this.rootMargin = s, this.IORaf = n, this._init()
        }
        var e = t.prototype;
        return e._init = function() {
            ...
            this.observer = new IntersectionObserver(function(e) {
                e.forEach(function(e) {
                    ...
                    e.isIntersecting ? (i && (i.isAlreadyIntersected = !0), t._setInview(e)) : i && i.isAlreadyIntersected && t._setOutOfView(e)
                })
            }, {
    ...
    var v = /*#__PURE__*/ function() {
            function t(t) {
                ...
                this.$el = void 0, this.id = void 0, this.needRaf = void 0, this.attributes = void 0, this.scrollOrientation = void 0, this.isAlreadyIntersected = void 0, this.intersection = void 0, this.metrics = void 0, this.currentScroll = void 0, this.translateValue = void 0, this.progress = void 0, this.lastProgress = void 0, this.modularInstance = void 0, this.progressModularModules = void 0, this.isInview = void 0, this.isInteractive = void 0, this.isInFold = void 0, this.isFirstResize = void 0, this.subscribeElementUpdateFn = void 0, this.unsubscribeElementUpdateFn = void 0, this.$el = o, this.id = l, this.needRaf = u, this.scrollOrientation = d, this.modularInstance = a, this.subscribeElementUpdateFn = h, this.unsubscribeElementUpdateFn = c, this.attributes = {
                    scrollClass: null != (e = this.$el.dataset.scrollClass) ? e : "is-inview",
                    scrollOffset: null != (i = this.$el.dataset.scrollOffset) ? i : "0,0",
                    scrollPosition: null != (s = this.$el.dataset.scrollPosition) ? s : "start,end",
            ...
            return e._init = function() {
                ...
                var e = t.smooth,
                    i = "vertical" === this.scrollOrientation ? window.innerHeight : window.innerWidth;
                ...
                this.metrics.offsetStart = this.currentScroll + ("vertical" === this.scrollOrientation ? t.top : t.left) - this.translateValue, this.metrics.offsetEnd = this.metrics.offsetStart + i, this.isInFold = this.metrics.offsetStart < e && !this.attributes.scrollIgnoreFold
                ...
                var t = "vertical" === this.scrollOrientation ? window.innerHeight : window.innerWidth,
                    ...
                    a = s.includes("%") ? t * parseInt(s.replace("%", "").trim()) * .01 : parseInt(s),
                    h = n.includes("%") ? t * parseInt(n.replace("%", "").trim()) * .01 : parseInt(n);
                ...
                switch (l) {
                    case "start":
                        ...
                        break;
                    case "middle":
                        this.intersection.end = this.metrics.offsetStart - h + .5 * e;
                        break;
                    default:
                ...
                var e, s = null != t ? t : (e = u(this.intersection.start, this.intersection.end, 0, 1, this.currentScroll)) < 0 ? 0 : e > 1 ? 1 : e;
                if (this.progress = s, s != this.lastProgress) {
                    if (this.lastProgress = s, this.attributes.scrollCssProgress && this._setCssProgress(s), this.attributes.scrollEventProgress && this._setCustomEventProgress(s), this.attributes.scrollModuleProgress)
                        for (var n, r = i(this.progressModularModules); !(n = r()).done;) {
                            var o = n.value;
                            this.modularInstance && this.modularInstance.call("onScrollProgress", s, o.moduleName, o.moduleId)
                        }
                    ...
                    if (t.length)
                        for (var s, n = i(t); !(s = n()).done;) {
                            ...
                            for (var o, l = i(e); !(o = l()).done;) {
                                var a = o.value;
                                r in a[1] && this.progressModularModules.push({
                                    moduleName: a[0],
                                    moduleId: r
                                })
                            }
                ...
                var t = d([this.intersection.start, this.intersection.end], this.currentScroll);
                return this.intersection.start === t ? "start" : "end"
            }, e._dispatchCall = function(t, e) {
                var i, s, n = null == (i = this.attributes.scrollCall) ? void 0 : i.split(","),
                    r = null == (s = this.attributes) ? void 0 : s.scrollCallSelf;
                if (n && n.length > 1) {
                    var o, l, a = n[0],
                        h = n[1],
                        c = n[2];
                    l = r ? this.$el.dataset["module" + h.trim()] : c, this.modularInstance && this.modularInstance.call(a.trim(), {
                        target: this.$el,
                        way: t,
                        from: e
                    }, h.trim(), null == (o = l) ? void 0 : o.trim())
                } else if (n) {
        ...
        m = ["scrollOffset", "scrollPosition", "scrollModuleProgress", "scrollCssProgress", "scrollEventProgress", "scrollSpeed"],
        p = /*#__PURE__*/ function() {
            function t(t) {
                var e = t.$el,
                    i = t.modularInstance,
                ...
                this.$scrollContainer = void 0, this.modularInstance = void 0, this.triggerRootMargin = void 0, this.rafRootMargin = void 0, this.scrollElements = void 0, this.triggeredScrollElements = void 0, this.RAFScrollElements = void 0, this.scrollElementsToUpdate = void 0, this.IOTriggerInstance = void 0, this.IORafInstance = void 0, this.scrollOrientation = void 0, e ? (this.$scrollContainer = e, this.modularInstance = i, this.scrollOrientation = r, this.triggerRootMargin = null != s ? s : "-1px -1px -1px -1px", this.rafRootMargin = null != n ? n : "100% 100% 100% 100%", this.scrollElements = [], this.triggeredScrollElements = [], this.RAFScrollElements = [], this.scrollElementsToUpdate = [], this._init()) : console.error("Please provide a DOM Element as scrollContainer")
            }
            var e = t.prototype;
            return e._init = function() {
                var t = this.$scrollContainer.querySelectorAll("[data-scroll]"),
                    e = Array.from(t);
                this._subscribeScrollElements(e), this.IOTriggerInstance = new c({
                ...
                for (var e, s = t.currentScroll, n = i(this.RAFScrollElements); !(e = n()).done;) e.value.onResize({
                    currentScroll: s
                })
            }, e.onRender = function(t) {
                for (var e, s = t.currentScroll, n = t.smooth, r = i(this.scrollElementsToUpdate); !(e = r()).done;) e.value.onRender({
                    currentScroll: s,
                    smooth: n
                })
                ...
                if (i.length) {
                    for (var s = 0; s < this.triggeredScrollElements.length; s++) {
                        ...
                        Array.from(i).indexOf(n.$el) > -1 && (this.IOTriggerInstance.unobserve(n.$el), this.triggeredScrollElements.splice(s, 1))
                    }
                    for (var r = 0; r < this.RAFScrollElements.length; r++) {
                        var o = this.RAFScrollElements[r];
                        Array.from(i).indexOf(o.$el) > -1 && (this.IORafInstance.unobserve(o.$el), this.RAFScrollElements.splice(r, 1))
                    }
                    i.forEach(function(t) {
                        ...
                        i && e._unsubscribeElementUpdate(i), s && (e.scrollElements = e.scrollElements.filter(function(t) {
                            return t.id != s.id
                        }))
                    })
                }
                ...
                for (var s = 0; s < t.length; s++) {
                    ...
                    this.scrollElements.push(o), r ? (this.RAFScrollElements.push(o), i && (this.IORafInstance.scrollElements.push(o), this.IORafInstance.observe(o.$el))) : (this.triggeredScrollElements.push(o), i && (this.IOTriggerInstance.scrollElements.push(o), this.IOTriggerInstance.observe(o.$el)))
                }
        ...
        f = /*#__PURE__*/ function() {
            function t(t) {
                ...
                this.$resizeElements = void 0, this.isFirstObserve = void 0, this.observer = void 0, this.resizeCallback = void 0, this.$resizeElements = e, this.resizeCallback = s, this.isFirstObserve = !0, this._init()
            }
            var e = t.prototype;
            return e._init = function() {
                var t = this;
    ...
    return function() {
        ...
        return i._init = function() {
            ...
            }), null == (t = this.lenisInstance) || t.on("scroll", this.scrollCallback), document.documentElement.setAttribute("data-scroll-orientation", this.lenisInstance.options.orientation), requestAnimationFrame(function() {
            ...
            this._bindScrollToEvents(), this.autoResize && ("ResizeObserver" in window ? this.ROInstance = new f({
            ...
            if (i) {
                var s = i.getAttribute("data-scroll-to-href") || i.getAttribute("href"),
                    n = i.getAttribute("data-scroll-to-offset") || 0,
                    r = i.getAttribute("data-scroll-to-duration") || this.lenisOptions.duration || g.duration;
                s && this.scrollTo(s, {
